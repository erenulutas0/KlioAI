...
The current production experience can be marketed as an English learning app. Turkish and English flows are the most mature today, while broader multilingual learning-market claims should wait until source, target, and feedback language parameters are implemented end to end.
