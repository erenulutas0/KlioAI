...
class WordSelectionSection extends StatelessWidget {
  ...
  Widget _buildSearchInput() {
    return Container(
      decoration: BoxDecoration(
        color: AppColors.cardBackgroundMedium.withValues(alpha: 0.6),
        borderRadius: BorderRadius.circular(10),
        border: Border.all(
          color: AppColors.cardBorderBlue.withValues(alpha: 0.3),
          width: 1.2,
        ),
      ),
      child: TextField(
  ...
  Widget _buildWordItem(BuildContext context, Map<String, String> word) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.cardBackgroundMedium.withValues(alpha: 0.4),
        borderRadius: BorderRadius.circular(10),
        border: Border.all(
          color: AppColors.cardBorderBlue.withValues(alpha: 0.2),
          width: 1,
        ),
      ),
      child: Row(
        children: [
              ...
              children: [
                  ...
                  children: [
                    ...
                    if (word['word'] == 'hello' ||
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              AppColors.cardBorderCyan.withValues(alpha: 0.2),
                ...
                if (word['translation']!.isNotEmpty) ...[
                  ...
                  Text(
                    word['translation']!,
                    style: TextStyle(
                      color: AppColors.textSlate400.withValues(alpha: 0.8),
                      fontSize: 13,
                    ),
                  ),
                ],
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: AppColors.cardBorderCyan.withValues(alpha: 0.2),
                shape: BoxShape.circle,
              ),
              child: const Icon(
                Icons.info_outline,
  ...
  Widget _buildStartButton() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: AppColors.cardBorderCyan.withValues(alpha: 0.4),
            blurRadius: 12,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Divider(
                        color: Colors.white.withValues(alpha: 0.1), height: 16),
                    const Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Eklendiği Tarih',
                            style:
