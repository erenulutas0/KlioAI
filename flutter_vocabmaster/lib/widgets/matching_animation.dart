  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color:
            const Color(0xFF0f172a).withValues(alpha: 0.5), // Deep dark blue bg
            ...
            ...List.generate(4, (index) {
              return AnimatedBuilder(
                ...
                builder: (context, child) {
                  double value =
                      (_radarController.value + (index * 0.25)) % 1.0;
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0xFF0ea5e9)
                          .withValues(alpha: 0.2), // Glassy Blue
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < starPositions.length; i++) {
      for (int j = i + 1; j < starPositions.length; j++) {
        Offset p1 = Offset(starPositions[i].dx * size.width,
            starPositions[i].dy * size.height);
        Offset p2 = Offset(starPositions[j].dx * size.width,
            starPositions[j].dy * size.height);
