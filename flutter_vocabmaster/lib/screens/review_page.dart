                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            _words.isEmpty ? 'Tekrar' : 'Tekrar (${_currentIndex + 1}/${_words.length})',
                          ...
                          : Padding(
                              ...
                              child: Dismissible(
                                ...
                                confirmDismiss: (direction) async {
                                  ...
                                  if (direction == DismissDirection.endToStart) {
                                    return _currentIndex < _words.length - 1;
                                  } else {
                                                          ...
                                                          child: _buildActionButton(
                                                            ...
                                                            onTap: () {
                                                              ScaffoldMessenger.of(context).showSnackBar(
                                                                const SnackBar(content: Text('Favorilere eklendi!'), duration: Duration(seconds: 1)),
                                                              );
                                                            },
                                                          ...
                                                          child: _buildActionButton(
                                                            ...
                                                            ScaffoldMessenger.of(context).showSnackBar(
                                                              SnackBar(
                                                                ...
                                                                backgroundColor: const Color(0xFF0ea5e9), // Neon Blue (Sky 500)
                        ...
                        children: [
                          Expanded(
                            child: OutlinedButton.icon(
                              onPressed: _words.isNotEmpty && _currentIndex > 0 ? _prevCard : null,
                          ...
                          Expanded(
                            child: ElevatedButton.icon(
                              onPressed: _words.isNotEmpty && _currentIndex < _words.length - 1 ? _nextCard : null,
