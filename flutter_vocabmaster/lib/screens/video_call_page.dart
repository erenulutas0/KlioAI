...
class _VideoCallPageState extends State<VideoCallPage>
  ...
  final List<Map<String, dynamic>> _transcriptData = [
    ...
    {
      'sender': 'Alex Johnson',
      'text': 'That\'s wonderful! What would you like to talk about?',
      'time': '00:12',
      'score': 97
    },
  ];
  ...
  void _toggleMic() {
    setState(() {
      ...
      _localStream
          ?.getAudioTracks()
          .forEach((track) => track.enabled = _isAudioEnabled);
    });
  }
  ...
  void _toggleCam() {
    setState(() {
      ...
      _localStream
          ?.getVideoTracks()
          .forEach((track) => track.enabled = _isVideoEnabled);
    });
  }
      ...
      Future.delayed(Duration(milliseconds: i * 150), () {
        ...
        setState(() {
          _floatingEmojis.add(_FloatingEmoji(
            ...
            startTop: MediaQuery.of(context).size.height * 0.75 +
                (i % 2 == 0 ? 0 : 30),
          ));
        });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor:
          const Color(0xFF0B1026), // REFERANS GÖRSEL 2 ve 3'teki Derin Lacivert
      body: Stack(
        fit: StackFit.expand,
        children: [
          // --- KATMAN 0: ARKA PLAN ---
      ...
      child: Column(
        ...
        children: [
          ...
          const Row(
            ...
            children: [
              Text("Practice your English with native speakers",
          ...
          ...List.generate(
              ...
              (index) => Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: Colors.white
                            .withValues(alpha: index % 5 == 0 ? 0.8 : 0.3),
  ...
  Widget _buildConnectingAnimation() {
    return Column(
      ...
      children: [
              ...
              ...List.generate(3, (index) {
                return AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    double value =
                        (_pulseController.value + index * 0.35) % 1.0;
                    return Opacity(
                      opacity: (1 - value) * 0.5,
                      child: Container(
                        width: 100 + (value * 150),
        ...
        Text("Connecting to User ${widget.matchedUserId.substring(0, 5)}...",
  ...
  Widget _buildAvatarMode() {
    return Column(
      children: [
        ...
        const Text("Speaking English with you",
            style: TextStyle(color: Color(0xFF38BDF8), fontSize: 16)),
      ],
    );
  }
            ...
            _isLocalRendererInitialized && _isVideoEnabled
                ...
                : const Center(
                    child: Icon(Icons.person_outline,
                        color: Colors.white70, size: 40)), // Video yoksa ikon
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: isMe
                      ? const Color(0xFF0F4C75).withValues(alpha: 0.8)
                      : const Color(0xFF323F68).withValues(alpha: 0.8),
  ...
  Widget _buildControlPanel() {
    return Row(
      ...
      children: [
        _buildDataCircleBtn(Icons.emoji_emotions_outlined, false,
            () => setState(() => _showEmojiPicker = !_showEmojiPicker)),
        _buildDataCircleBtn(_isAudioEnabled ? Icons.mic : Icons.mic_off,
            !_isAudioEnabled, _toggleMic),
  ...
  Widget _buildDataCircleBtn(IconData icon, bool isAlert, VoidCallback onTap) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child:
            Icon(icon, color: isAlert ? Colors.black : Colors.white, size: 22),
      ),
    );
  }
      ...
      builder: (context, value, child) {
        return Positioned(
          ...
          child: Opacity(
            ...
            opacity:
                (value < 50 || value > MediaQuery.of(context).size.width - 50)
                    ? 0.0
                    : 0.6,
...
class _FloatingEmoji {
  ...
  _FloatingEmoji(
      {required this.id, required this.emoji, required this.startTop});
}
